<template>
  <div class="esg-reporting">
    <h2 class="mb-4">ESG Reporting & Compliance</h2>
        ...
        <div v-for="m in metrics.slice(0, 3)" :key="m.id" class="col-md-4">
          <div class="card">
            <div class="card-body">
              ...
              <div class="display-4" :class="m.status === 'on-track' ? 'text-success' : m.status === 'warning' ? 'text-warning' : 'text-primary'">{{ m.value }} {{ m.unit }}</div>
